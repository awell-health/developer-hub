...
**The collection of Resource types and Resources that describes all the healthcare data available in your account (i.e. the actual data).** This evolves with the care flows that you build and the systems that you connect to Awell.
