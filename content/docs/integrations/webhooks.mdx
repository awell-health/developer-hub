...
Webhooks can be configured on a per pathway basis in the Awell Studio (see `Settings > Webhooks`). See the <a href="https://help.awellhealth.com/en/" target="_blank">Awell Studio documentation</a> for more information on how to configure Webhooks.
...
* <u>Activity completed:</u> triggered every time an activity in the pathway is
