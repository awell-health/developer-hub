...
export const sessionsAndLink: CategoryType[] = [
  {
    ...
    Awell <strong>communicates directly</strong> with the patient (e.g. via SMS or email).`,
    effort: 1,
  },
  {
    name: 'Sessions',
...
export const sections: SectionType[] = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        join: true,
        categories: {
          join: `There is a <strong>new activity</strong> in the care flow that<br/><strong>needs completion by a patient</strong>.`,
        },
      },
      {
        ...
        categories: {
          ...
          'Hosted Pages Links':
            'Your system (e.g. via API call action, webhook, ...) or directly to the patient (e.g. SMS/email).',
        },
      },
      {
        name: 'URL created by',
      ...
      },
      {
        ...
        categories: {
          Sessions: `<strong>Just-In-Time</strong>, when a patient clicks a Call To Action button.`,
          'Hosted Pages Links':
            '<strong>Upfront</strong>, when care flow is started. The URL is immediately included in the payload sent to your system or notification to the patient.',
        },
      },
      {
        name: 'Scope',
        join: true,
        categories: {
          join: 'Only gives access to activities for a<br/><strong>single patient/stakeholder</strong> in a <strong>single care flow</strong>.',
        },
      },
      {
        name: 'Expiration',
