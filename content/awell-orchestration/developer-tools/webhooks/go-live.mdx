...
After [testing your webhook endpoint](/awell-orchestration/developer-tools/webhooks/test-webhooks) via the pathway preview (test endpoint url), register the production endpoint via the pathway settings so Awell knows where to deliver events when Orchestrating your care pathway.
