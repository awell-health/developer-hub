...
<HowToUse
  stories={[
    {
      title: 'Create a Timeline overview of a care flow',
      url: '/coming-soon',
      badges: ['Custom integration', 'Elements', 'Timeline'],
      description:
        "Learn how to construct a Gantt or Timeline-style view that gives your users a high-level view of a patient's progress through a care flow.",
    },
  ]}
/>
