...
The `pathwayElements` query is perfect for constructing Gantt or Timeline-style views that give users high-level or granular views of a patient's progress through a care flow.

We leverage this query ourselves to construct a Timeline view, you can see an example below. There are a multitude of timeline and gantt libraries out there but we've used [DHTMLX Gantt](https://dhtmlx.com/docs/products/dhtmlxGantt/).
