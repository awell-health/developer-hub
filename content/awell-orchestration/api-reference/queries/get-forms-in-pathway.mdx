...
This query allows us to fetch the form details for all form defintions in a published care flow/pathway.

## All forms vs. forms that will be activated

Please note that this query returns all forms in a published care flow or pathway but that this doesn't neccesarely mean that all these forms will be completed as that is dependent on the logic built into the care flow.
