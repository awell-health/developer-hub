...
<code className="language-json" highlightedRows={[3, 4, 5, 6, 7, 8, 9, 10, 11]}>
  {`
{
  "release_id": "{{ RELEASE_ID }}",
  "category": [
  ...
  stories={[
    {
      ...
      url: '/coming-soon',
      badges: ['Custom integration', 'Data'],
      description:
        'Learn how to create a data dictionary displaying all data points that are collected in a given pathway version.',
    },
  ]}
/>
