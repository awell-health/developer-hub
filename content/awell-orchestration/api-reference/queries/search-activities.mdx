...
<HowToUse
  stories={[
    {
      title: 'Create a working list with activities',
      url: '/coming-soon',
      badges: ['Custom integration', 'Activities', 'Operations'],
      description:
        'Learn how to create a dashboard or list with pending activities and who needs to do what when.',
    },
  ]}
/>
