...
**If you'd like to fetch activities in a specific care flow**, use the [GetPathwayActivities query](/awell-orchestration/api-reference/queries/get-pathway-activities).
