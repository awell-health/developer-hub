...
We have 2 environments you can interact with: **Sandbox** & **Production**. Our production environment is only available for customers with live implementations and is available across multiple geographies. The Sandbox environment can be used to explore, test, and develop your integrations.
...
> [https://api.uk.awellhealth.com/orchestration/m2m/graphql](https://api.uk.awellhealth.com/orchestration/m2m/graphql)
