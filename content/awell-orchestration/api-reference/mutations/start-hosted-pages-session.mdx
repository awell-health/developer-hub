...
Please note that this mutation can only be used to create a Hosted Pages session for a care flow that is already active. Have a look at our [Start pathway and Hosted Pages session mutation](/awell-orchestration/api-reference/mutations/start-pathway-and-hosted-pages-session). If you would like to start a care flow and immediately create a session.
