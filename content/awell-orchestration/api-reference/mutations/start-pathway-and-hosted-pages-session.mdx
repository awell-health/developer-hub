...
<CodeBlock className="language-json" highlightedRows={[[3, 3]]}>
  {`
{
  "input": {
...
<CodeBlock className="language-json" highlightedRows={[[4]]}>
  {`
    {
      "input": {
        "pathway_definition_id": "{{PATHWAY_DEFINITION_ID}}",
...
<CodeBlock className="language-json" highlightedRows={[[4, 7]]}>
  {`
    {
      "input": {
        "pathway_definition_id": "{{PATHWAY_DEFINITION_ID}}",
...
<CodeBlock className="language-json" highlightedRows={[[4, 9]]}>
  {`
{
  "input": {
    "pathway_definition_id": "{{PATHWAY_DEFINITION_ID}}",
...
<CodeBlock className="language-json" highlightedRows={[[4, 5]]}>
  {`
{
  "input": {
    "pathway_definition_id": "{{PATHWAY_DEFINITION_ID}}",
