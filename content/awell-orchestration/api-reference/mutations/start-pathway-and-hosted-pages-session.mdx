...
Every pathway is linked to a patient in Awell. If you would like to create a new patient with patient with a specific identifier or start a pathway for a existing patient you can pass patient identifier. Learn more about [identifiers](https://developers.awellhealth.com/awell-orchestration/docs/misc/patient-identifiers).
