...
The `pathway_id` is the id of the patient care flow (pathway) for which you want to stop a track. The `track_id` is the id of the track that you want to stop. You can optionally provide a `reason` for stopping the track.
