...
The `pathway_id` is the id of the patient care flow for which you want to stop a track. Any query that returns a patient care flow such as [patientPathways](/awell-orchestration/api-reference/queries/get-patient-care-flows) or [pathways](/awell-orchestration/api-reference/queries/get-care-flows), will return a care flow id.
