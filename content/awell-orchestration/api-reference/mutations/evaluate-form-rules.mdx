...
<figure className="w-full flex flex-col justify-center text-center pt-4">
  ...
  >
    <img
      src="https://static.swimlanes.io/8825aba66c32d85b596003378c23f3df.png"
...
Important to note is that the response of this mutation returns an array of results stating what questions should be hidden (i.e. the conditions to show a given question are not satisfied).
