...
**We use Mirth Connect (Mirth) as an integration engine to handle ADT feeds** (read more in ["Healthcare interoperability"](/awell-orchestration/docs/data/healthcare-interoperability)). Mirth is configured to intercept your ADT messages and upon receiving a message, we process it, extracting key patient information and identifying which care flow to start.
