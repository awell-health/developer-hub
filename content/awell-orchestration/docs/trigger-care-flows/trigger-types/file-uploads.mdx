...
A convenient way to get care flows started in Awell with maximum control but requiring practically no engineering lift is by uploading files via Awell’s FTP Connector. Moreover, it enables you to conveniently trigger multiple care flows in batch.
