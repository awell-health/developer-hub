...
Note that each incoming webhook that hits the provided URL starts a care flow for an anonymous patient.

### Non-anonymous patients

To create a new patient or start a care flow for a known patient you can padd patient identifier in the payload.
