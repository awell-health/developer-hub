...
- [Start care flow](/awell-orchestration/api-reference/mutations/start-careflow)
- [Start care flow and Hosted Pages session](/awell-orchestration/api-reference/mutations/start-pathway-and-hosted-pages-session)
- [Awell Hosted Pages Link](/awell-orchestration/docs/trigger-care-flows/trigger-types/awell-hosted-pages-link)
- [Incoming Webhooks](/awell-orchestration/docs/trigger-care-flows/trigger-types/incoming-webhooks)
- [Get patient](/awell-orchestration/api-reference/queries/get-patient)
