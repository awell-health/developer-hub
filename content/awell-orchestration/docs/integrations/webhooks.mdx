...
You can subscribe webhooks to the following events:
...
- <u>Pathway started:</u> triggered every time a pathway is started
- <u>Pathway completed:</u> triggered every time a pathway is completed

See the [API Reference](/awell-orchestration/api-reference/overview/endpoints) for more information about the available events, including sample payloads.
