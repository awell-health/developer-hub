...
Our Sandbox & Production environments are completely separate environments. They have their own dedicated user management / authentication provider, data storage, deployments, etc. Additionally, our production environments are available regionally, currently they are available in the EU and US.
