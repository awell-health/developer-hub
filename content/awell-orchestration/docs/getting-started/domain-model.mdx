...
> Awell does not enforce the uniqueness of the `patient_code` amongst your patients. If you use unique identifiers, you can use the [`searchPatientsByPatientCode` query](/api-reference/queries/search-patient) before creating patients to enforce the uniqueness constraint on your end.

See the [API Reference](/awell-orchestration/api-reference/overview/schema) for more information about the user type.
...
See the [API Reference](/awell-orchestration/api-reference/overview/schema) for more information about the pathway type.
...
See the [API Reference](/awell-orchestration/api-reference/overview/schema) for more information about the activity type.
...
See the [API Reference](/awell-orchestration/api-reference/overview/schema) for more information about the data point definition type.
