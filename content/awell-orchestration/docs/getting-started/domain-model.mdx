...
<Alert type="info">
  <p>
    Note that integrating directly with our API is only one of the ways you can orchestrate care flows in Awell. Check out how to [Interact with activities](/awell-orchestration/docs/activities/overview-activities)
  </p>
</Alert>
