...
**Awell Hosted Pages is a prebuilt app that allows you to let patients and other stakeholders interact with their pending care flow activities in Awell.** Hosted Pages' [built-in and customizable](#) features reduces your development time and can get you up and running with Awell in no time.
...
You can integrate Hosted Pages by creating a session via our API which will return you a session URL or let Awell generate the links for you and we'll send them to your systems at the right time ([learn more about Sessions and Links](#)). Hosted Pages can be embedded in your website or you can redirect users to an Awell-hosted page.
