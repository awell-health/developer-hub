...
The data catalog lists all the data points that are collected in the lifecycle of a care flow (more information on the data catalog [here](https://help.awellhealth.com/en/articles/4791428-data-catalog)). Using the data catalog you can identify the data points that you would like to track in a dashboard.
