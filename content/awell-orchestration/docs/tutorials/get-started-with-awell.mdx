...
<a
  href="/awell-orchestration/api-reference/queries/get-patients"
  className="button"
  target="_blank"
...
<a
  href="/awell-orchestration/api-reference/queries/get-pending-activities"
  className="button"
  target="_blank"
...
<a
  href="/awell-orchestration/api-reference/queries/get-form"
  className="button"
  target="_blank"
...
<a
  href="/awell-orchestration/api-reference/mutations/submit-form-response"
  className="button"
  target="_blank"
...
<a
  href="/awell-orchestration/api-reference/queries/get-form-response"
  className="button"
  target="_blank"
...
<a
  href="/awell-orchestration/api-reference/queries/get-patient-pending-activities"
  className="button"
  target="_blank"
  title="Open API reference for pending activities query"
>
...
<a
  href="/awell-orchestration/api-reference/queries/get-message"
  className="button"
  target="_blank"
...
<a
  href="/awell-orchestration/api-reference/mutations/mark-message-as-read"
  className="button"
  target="_blank"
...
<a
  href="/awell-orchestration/api-reference/queries/get-pathway-activities"
  className="button"
  target="_blank"
