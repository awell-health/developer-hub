...
**Awell provides Single Sign-On (SSO) functionality allowing your users to access all of Awell's applications through your identity provider.** It works by transferring the user’s identity from one place (your identity provider) to another (Awell, the service provider).
