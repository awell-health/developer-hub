...
> Note `baseline_info` is only needed when you want to pass baseline data points values to your pathway on pathway start. Keep in mind that, if your pathway has required baseline data points, it will not start until all required baseline data points have a value.
