---
title: Get started
description: This guide covers the prerequisites and tools you need to start building a custom action extension.
---

## Prerequisites

**Before you can create your first Custom Action Extension make sure you have the following prerequisites.**
