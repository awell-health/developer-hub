---
title: Get started
description: This guide covers the prerequisites and tools you need to start building Custom Actions.
---

## Github repository

Building an extension to create Custom Actions needs to be done via our `@awell-extensions/custom-actions` repository. Check out the repository locally to start contributing and create your first Custom Actions!

<a
  title="Open Github repo"
  href="https://github.com/awell-health/action-extensions"
  target="_blank"
...
**Before you can create your first extension to create Custom Actions make sure you have the following prerequisites.**
