...
The configuration fields for your action. These configuration fields are displayed in Awell Studio when a user adds the action to a pathway. Learn more about action fields [here](/awell-extensions/docs/custom-actions/development/actions/action-fields)
...
Learn more about the `onActivityCreated` function [here](/awell-extensions/docs/custom-actions/development/actions/on-acitivty-created)
