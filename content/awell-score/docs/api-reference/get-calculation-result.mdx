...
Please note that this endpoint can only be used if you also use the [v2 endpoint to perform calculations](/awell-score/docs/api-reference/perform-calculation) as the v1 endpoint does not return an `id` for the calculation result that you need to call this endpoint.
