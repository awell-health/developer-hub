...
export const buttonColors: { [key in ButtonColorType]: string } = {
  ...
  sky: 'text-white bg-blue-600 highlight-white/20 hover:bg-blue-500 dark:bg-sky-500 dark:hover:bg-sky-600 disabled:opacity-60 disabled:cursor-not-allowed dark:focus:ring-offset-slate-900 dark:ring-sky-700',
