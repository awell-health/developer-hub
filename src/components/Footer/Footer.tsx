      ...
      <div className="mx-auto divide-y divide-slate-200 dark:divide-slate-700">
        <div className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-600">
          <div className="leading-none text-slate-700 dark:text-slate-200">
            ...
            <div className="text-xs mt-4 text-center text-slate-500 mx-auto max-w-2xl leading-snug">
              <p>
                Awell is a workflow-orchestration platform, and is by itself not
                intended to diagnose, treat or make patient-specific clinical
                decisions. All clinical content and logic are created and
                governed by your care organization.
              </p>
            </div>
          </div>
        </div>
