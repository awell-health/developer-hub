...
export const Footer: FC<FooterProps> = ({
  ...
  const footerClass = footerHeight === 'standard' ? 'text-sm leading-6' : 'pb-16 text-sm leading-6'
  const base = 'mx-auto divide-y divide-slate-200 dark:divide-slate-700'
  const footerSubClass = dividerWidth === 'standard' ? `max-w-7xl px-4 sm:px-6 md:px-8 ${base}` : base 
  return (
    <footer className={footerClass}>
      <div className={footerSubClass}>
