...
const badges: { [key in string]: BadgeType } = {
  ...
  careflow: { label: 'Care flow', color: 'purple' },
...
export const apiMenu: MenuType = [
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        title: 'Get care flows',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/queries/get-care-flows`,
        badge: badges.careflow,
      },
      {
        title: 'Get published care flows',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/queries/get-published-care-flows`,
        badge: badges.careflow,
      },
      {
        title: 'Get patient care flows',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/queries/get-patient-care-flows`,
        badge: badges.careflow,
      },
      {
        title: 'Get care flow',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/queries/get-care-flow`,
        badge: badges.careflow,
      },
      {
      ...
      {
        title: 'Get care flow data points',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/queries/get-care-flow-data-points`,
        badge: badges.careflow,
      },
      {
        title: 'Get care flow elements',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/queries/get-care-flow-elements`,
        badge: badges.careflow,
      },
      {
      ...
      },
      {
        ...
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/queries/get-care-flow-activities`,
      ...
      {
        title: 'Get all forms in a care flow',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/queries/get-forms-in-care-flow`,
        badge: badges.elements,
      },
      {
        title: 'Get message',
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        title: 'Delete care flow',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/mutations/delete-care-flow`,
        badge: badges.careflow,
      },
      {
        title: 'Start care flow',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/mutations/start-care-flow`,
        badge: badges.careflow,
      },
      {
        title: 'Stop care flow',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/mutations/stop-care-flow`,
        badge: badges.careflow,
      },
      {
      ...
      {
        title: 'Start care flow and Hosted Pages session',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/mutations/start-care-flow-and-hosted-pages-session`,
        badge: badges.session,
      },
    ],
  },
  {
    ...
    submenu: [
      {
        title: 'Care flow started',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/webhooks/care-flow-started`,
        badge: badges.careflow,
      },
      {
        title: 'Care flow stopped',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/webhooks/care-flow-stopped`,
        badge: badges.careflow,
      },
      {
        title: 'Care flow deleted',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/webhooks/care-flow-deleted`,
        badge: badges.careflow,
      },
      {
        title: 'Care flow completed',
        path: `/${Space.AWELL_ORCHESTRATION}/api-reference/webhooks/care-flow-completed`,
        badge: badges.careflow,
      },
      {
