  ...
  return (
    <div>
      <SEO
        ...
        url={`/${Space.AWELL_PLUGINS}/api-reference/${slug}`}
        canonicalUrl={`/${Space.AWELL_PLUGINS}/api-reference/${slug}`}
      />
      {heading && (
        <DocsHeader
          heading={heading}
          ...
          description={frontMatter.description}
          badge={badge}
          githubUrl={`/content/${Space.AWELL_PLUGINS}/api-reference/${slug}.mdx`}
          postman={{
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  const { frontMatter, content } = await getPluginsApiDoc(slugString)
...
export const getStaticPaths: GetStaticPaths = () => {
  const docs = getAllPluginsApiDocs()
