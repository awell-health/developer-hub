...
import {
  getAllStudioDocs,
  getStudioDoc,
} from '../../../src/utils/content/awell-studio'
  ...
  return (
    <div>
      <SEO
        ...
        url={`/${Space.AWELL_STUDIO}/docs/${slug}`}
        canonicalUrl={`/${Space.AWELL_STUDIO}/docs/${slug}`}
      />
      {heading && (
        <DocsHeader
          heading={heading}
          title={frontMatter.title}
          description={frontMatter.description}
          githubUrl={`/content/${Space.AWELL_STUDIO}/docs/${slug}.mdx`}
          postman={{
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  const { frontMatter, content } = await getStudioDoc(slugString)
