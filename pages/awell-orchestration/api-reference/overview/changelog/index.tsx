...
import { getAllOrchestrationReleasesChangelogs } from '../../../../../src/utils/content/awell-orchestration'
  ...
  return (
    <>
      <SEO
        ...
        url={`/awell-orchestration/api-reference/overview/changelog`}
        canonicalUrl={`/awell-orchestration/api-reference/overview/changelog`}
      />
      <div className="max-w-3xl mx-auto xl:max-w-none xl:ml-0 xl:mr-[15.5rem] xl:pr-16">
        <DocsHeader
          ...
          githubUrl="/pages/awell-orchestration/api-reference/overview/changelog/index.tsx"
        />
      ...
      <div className="grid gap-3 sm:gap-6 mx-auto grid-cols-2 sm:grid-cols-3">
        {releases.map((release) => (
          ...
          >
            ...
            <a
              href={`/awell-orchestration/api-reference/overview/changelog/${release.slug}`}
