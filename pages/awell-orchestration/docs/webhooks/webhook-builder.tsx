...
import { stack } from '@/content/awell-orchestration/docs/webhooks/webhook-builder'
  ...
  return (
    <div>
      <SEO
        ...
        url={`/awell-orchestration/docs/webhooks/webhook-builder`}
        canonicalUrl={`/awell-orchestration/docs/webhooks/webhook-builder`}
      />
