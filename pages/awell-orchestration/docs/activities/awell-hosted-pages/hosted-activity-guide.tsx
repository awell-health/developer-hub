  ...
  return (
    <div>
      <SEO
        ...
        url={`/${Space.AWELL_ORCHESTRATION}/docs/activities/awell-hosted-pages/hosted-activity-guide`}
        canonicalUrl={`/${Space.AWELL_ORCHESTRATION}/docs/activities/awell-hosted-pages/hosted-activity-guide`}
      />
        ...
        <FAQ
          faqs={[
            ...
            },
            {
              ...
              answer:
                'By default, sessions expire after 60 minutes but the timer is reset after every completion of an activity. A session also expires when there are no pending activities left for stakeholder in the pathway.',
            },
            {
              question:
