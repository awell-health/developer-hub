...
import {
  getAllExtensionsDeveloperToolsPages,
  getExtensionsDeveloperToolsPage,
} from '@/utils/content/awell-extensions'
  ...
  return (
    <div>
      <SEO
        ...
        url={`/${Space.AWELL_EXTENSIONS}/developer-tools/${slug}`}
        canonicalUrl={`/${Space.AWELL_EXTENSIONS}/developer-tools/${slug}`}
      />
      {heading && (
        <DocsHeader
          heading={heading}
          ...
          description={frontMatter.description}
          badge={badge}
          githubUrl={`/content/${Space.AWELL_EXTENSIONS}/developer-tools/${slug}.mdx`}
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  const { frontMatter, content } = await getExtensionsDeveloperToolsPage(
    slugString
  )
...
export const getStaticPaths: GetStaticPaths = () => {
  const docs = getAllExtensionsDeveloperToolsPages()
