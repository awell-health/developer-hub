  ...
  return (
    <div>
      <SEO
        ...
        url={`/api-reference/changelog/${slug}`}
        canonicalUrl={`/api-reference/overview/changelog/${slug}`}
      />
      <DocsHeader
        heading="Changelog"
      ...
      <div>
        ...
        <div className="mt-12">
          <div className="text-base leading-6 text-slate-700 font-semibold flex items-center dark:text-slate-200">
            <Link href="/api-reference/overview/changelog">
              <a
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  const { frontMatter, content } = await getReleaseChangelog(slugString)
